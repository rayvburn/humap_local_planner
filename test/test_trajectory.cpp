...
// Simple: without angular velocity
TEST(HuberoTrajectory, trajectoryFromObject2) {
	geometry_msgs::Point pos;
	pos.x = 0.0;
	pos.y = 0.0;
	pos.z = 0.0;
...
TEST(HuberoTrajectory, trajectoryAngularFromBaseLocalPlanner) {
	base_local_planner::Trajectory traj;
...
TEST(HuberoTrajectory, trajectoryNonholonomicFromBaseLocalPlanner) {
	base_local_planner::Trajectory traj;
