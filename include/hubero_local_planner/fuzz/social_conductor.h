...
public:
	///	defines distance of interactions that are negligible
	static constexpr double SOCIAL_BEHAVIOUR_RANGE = 4.0;

	/// \brief Default constructor
	SocialConductor() = default;

	/// \brief Updates internal state according to a given structure's content
	void initialize(std::shared_ptr<const hubero_local_planner::BehaviourParams> cfg);
	...
	static double computeBehaviourStrength(const double& dist_to_agent);
