...
#ifndef INCLUDE_HUBERO_LOCAL_PLANNER_UTILS_SHIFTREGISTER_H_
#define INCLUDE_HUBERO_LOCAL_PLANNER_UTILS_SHIFTREGISTER_H_
...
#endif /* INCLUDE_HUBERO_LOCAL_PLANNER_UTILS_SHIFTREGISTER_H_ */
