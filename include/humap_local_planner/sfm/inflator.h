...
#include <humap_local_planner/inflation/border.h>
#include <humap_local_planner/inflation/box.h>
#include <humap_local_planner/inflation/circle.h>
#include <humap_local_planner/inflation/ellipse.h>
...
private:
	...
	findIntersectionTypeOfBB(const inflation::Box &actor_bb, const inflation::Box &object_bb);
...
public:
	...
	static std::tuple<ignition::math::Pose3d, ignition::math::Vector3d> findClosestPointsActorBox(
		...
		if ( actor_bound.getType() == inflation::BORDER_RECTANGLE ) {
