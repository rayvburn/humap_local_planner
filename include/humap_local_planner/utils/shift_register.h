...
#ifndef INCLUDE_HUMAP_LOCAL_PLANNER_UTILS_SHIFTREGISTER_H_
#define INCLUDE_HUMAP_LOCAL_PLANNER_UTILS_SHIFTREGISTER_H_
...
#endif /* INCLUDE_HUMAP_LOCAL_PLANNER_UTILS_SHIFTREGISTER_H_ */
