...
void HumapConfigROS::loadFromParamServer(const ros::NodeHandle& nh) {
	ROS_INFO("[HumapConfigROS] loadFromParamServer()");
...
void HumapConfigROS::reconfigure(HumapPlannerConfig& cfg) {
	ROS_INFO("[HumapConfigROS] reconfigure()");
	...
	sfm_->filter_forces = cfg.filter_forces;
