...
Pose HumapPlanner::getPoseFromPlan(const double& dist_from_current_pose) const {
	if (global_plan_.empty()) {
		ROS_ERROR_NAMED("HumapPlanner", "Cannot choose local goal because global plan is empty");
		return Pose();
	}
